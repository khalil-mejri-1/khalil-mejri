...
const handleClick = (e, index) => {
  ...
  // ✅ استدعاء scrollToSection من الأب
  if (onClickItem) {
    onClickItem(items[index].label);
  }
};
  ...
  return (
    <div className="gooey-nav-container" ref={containerRef}  data-dark={darkMode ? "true" : "false"}
>
      <nav>
        <ul ref={navRef}>
